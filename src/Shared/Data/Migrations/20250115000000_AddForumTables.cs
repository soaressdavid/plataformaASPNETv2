...
namespace Shared.Data.Migrations
{
    ...
    public partial class AddForumTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ForumThreads_Challenges_ChallengeId",
                        column: x => x.ChallengeId,
                        principalTable: "Challenges",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_ForumThreads_Lessons_LessonId",
                        column: x => x.LessonId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsAcceptedAnswer = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false, defaultValue: false)
                },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ForumThreads_ChallengeId",
                table: "ForumThreads",
                column: "ChallengeId");

            migrationBuilder.CreateIndex(
                name: "IX_ForumThreads_LessonId",
                table: "ForumThreads",
                column: "LessonId");

            migrationBuilder.CreateIndex(
                name: "IX_ForumThreads_Category",
                table: "ForumThreads",
                column: "Category");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ForumThreads_IsPinned_CreatedAt",
                table: "ForumThreads",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ForumPosts_ThreadId_Upvotes",
                table: "ForumPosts",
                columns: new[] { "ThreadId", "Upvotes" });

            migrationBuilder.CreateIndex(
                name: "IX_ForumPostVotes_PostId_UserId",
        ...
        {
            migrationBuilder.DropTable(name: "ForumPostVotes");
            migrationBuilder.DropTable(name: "ForumPosts");
            migrationBuilder.DropTable(name: "ForumThreads");
        }
    }
}
